...
class Env
{
    ...
    public static function default_image_processor(){
        $default =  Env::imagick_loaded() ? 'imagick' : 'gd';

        // Handle an exception where some servers don't have WebP available.
        if($default === 'imagick' && ! static::imagick_supports_webp()){
            return 'gd';
        }
